...
/**
 * Display top content stats in plugin's admin area.
 *
...
$listaPosts = formatData('tc',$arr_wcwizard_posts);
...
<table class="widefat">
	...
	<tbody>
		...
		<?php if ($wcwizard_counter_top_content == 19) break; ?>
		<?php $wcwizard_counter_top_content++; ?>
		<?php endforeach; ?>
